    ...
    //             if ($(".toggle").bind("click", function() {})) {
    //                 $(".address-holder").slideToggle("slow");
    //                 $("input").prop('disabled', true);
    //             }
    //             document.getElementsById("#toggle").classList.add('MyClass');
    //             // $(".toggle").click(function() {
    //             //     $(".address-holder").slideToggle("slow");
    //             // });
    //             // alert($(this).text());
    ...
    //         //     if (isChecked) {
    //         //         selectedData = $switchLabel.prop('data-on');
    //         //         $("input]").prop('disabled', true);
    //         //         // $("input[name='inclusion']").prop('disabled', false);
    //         //         $(".address-holder").slideToggle("slow");
    //         //     } else {
    //         //         selectedData = $switchLabel.prop('data-off');
    //         //         $("input").prop('disabled', false);
