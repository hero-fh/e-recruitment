...
var ZeroClipboard_TableTools = {
	...
	applicants: {}, // registered upload applicants on page, indexed by id
...
ZeroClipboard_TableTools.Client.prototype = {
	...
	destroy: function() {
		...
		if (this.domElement && this.div) {
			...
			$.each( ZeroClipboard_TableTools.applicants, function ( id, client ) {
				if ( client === that ) {
					delete ZeroClipboard_TableTools.applicants[ id ];
				}
			} );
		}
	},
...
DataTable.Api.register( 'buttons.resize()', function () {
	$.each( ZeroClipboard_TableTools.applicants, function ( i, client ) {
