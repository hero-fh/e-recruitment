  ...
  if ($.uiBackCompat !== false) {
    ...
    $.widget("ui.button", $.ui.button, {
      ...
      _create: function () {
        ...
        if (
          !this.options.icon &&
          (this.options.icons.success || this.options.icons.secondary)
        ) {
          if (this.options.icons.success) {
            this.options.icon = this.options.icons.success;
          } else {
            this.options.icon = this.options.icons.secondary;
            this.options.iconPosition = "end";
          }
        } else if (this.options.icon) {
          this.options.icons.success = this.options.icon;
        }
        this._super();
      },
      ...
      _setOption: function (key, value) {
        ...
        if (key === "icon") {
          this.options.icons.success = value;
        }
        if (key === "icons") {
          if (value.success) {
            this._super("icon", value.success);
  ...
  $.extend(Datepicker.prototype, {
    ...
    _generateHTML: function (inst) {
      ...
      controls = !inst.inline
        ? "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-success ui-corner-all' data-handler='hide' data-event='click'>" +
