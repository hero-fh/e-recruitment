(function() {
    ...
    var db = {
        ...
        loadData: function(filter) {
            return $.grep(this.applicants, function(client) {
        ...
        insertItem: function(insertingClient) {
            this.applicants.push(insertingClient);
        },

        updateItem: function(updatingClient) { },

        deleteItem: function(deletingClient) {
            var clientIndex = $.inArray(deletingClient, this.applicants);
            this.applicants.splice(clientIndex, 1);
        }
