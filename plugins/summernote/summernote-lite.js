          ...
          LinkDialog_createClass(LinkDialog, [
            {
              ...
              value: function initialize() {
                ...
                var buttonClass =
                  "btn btn-success note-btn note-btn-success note-link-btn";
          ...
          ImageDialog_createClass(ImageDialog, [
            {
              ...
              value: function initialize() {
                ...
                var buttonClass =
                  "btn btn-success note-btn note-btn-success note-image-btn";
                var footer = '<input type="button" href="#" class="'
                  .concat(buttonClass, '" value="')
          ...
          VideoDialog_createClass(VideoDialog, [
            {
              ...
              value: function initialize() {
                ...
                var buttonClass =
                  "btn btn-success note-btn note-btn-success note-video-btn";
                var footer = '<input type="button" href="#" class="'
                  .concat(buttonClass, '" value="')
      ...
      /***/ 51: /***/ function (
        ...
        var videoDialog = function videoDialog(opt) {
          var body =
            ...
            "</div>";
          var footer = [
            '<button type="button" href="#" class="note-btn note-btn-success note-video-btn disabled" disabled>',
        ...
        var imageDialog = function imageDialog(opt) {
          var body =
            ...
            "</div>";
          var footer = [
            '<button href="#" type="button" class="note-btn note-btn-success note-btn-large note-image-btn disabled" disabled>',
        ...
        var linkDialog = function linkDialog(opt) {
          var body =
            ...
            "</label></div>";
          var footer = [
            '<button href="#" type="button" class="note-btn note-btn-success note-link-btn disabled" disabled>',
