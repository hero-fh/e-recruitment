...
class QRtools
{
    ...
    public static function log($outfile, $err)
    {
        if (QR_LOG_DIR !== false) {
            if ($err != '') {
                if ($outfile !== false) {
                    file_put_contents(QR_LOG_DIR . basename($outfile) . '-errors.txt', date('m-d-Y H:i:s') . ': ' . $err, FILE_APPEND);
                } else {
                    file_put_contents(QR_LOG_DIR . 'errors.txt', date('m-d-Y H:i:s') . ': ' . $err, FILE_APPEND);
                }
            }
        }
    }
