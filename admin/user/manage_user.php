					...
					<div class="row">
						<div class="form-group col-12">
							...
							<select name="type" id="type" class="custom-select" value="<?php echo isset($meta['type']) ? $meta['type'] : '' ?>" required>
								...
								<option value="2"> <?php echo isset($type) && $type = 2 ? 'selected' : '' ?>Supervisor/Manager</option>
								<option value="3" <?php echo isset($type) && $type = 3 ? 'selected' : '' ?>>HR</option>
								<option value="4" <?php echo isset($type) && $type = 4 ? 'selected' : '' ?>>For Audit</option>
							</select>
						</div>
					</div>
					<!-- <div class="form-group col-6">
