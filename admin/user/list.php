				...
				<tbody>
					...
					?>
						<tr>
							...
							<td>
								<?php if ($row['type'] == 1) { ?>
									<p class="m-0"><?php echo ($row['type'] == 1) ? "Adminstrator" : "Department Section Head / Manager" ?></p>
								<?php } elseif ($row['type'] == 2) { ?>
									<p class="m-0"><?php echo ($row['type'] == 2) ? "Department Section Head / Manager" : "" ?></p>
								<?php } elseif ($row['type'] == 3) { ?>
									<p class="m-0"><?php echo ($row['type'] == 3) ? "HR" : "" ?></p>
								<?php } elseif ($row['type'] == 4) { ?>
									<p class="m-0"><?php echo ($row['type'] == 4) ? "Auditor" : "" ?></p>
								<?php } ?>
							</td>
							<td align="center">
								...
								<div class="dropdown-menu" role="menu">
									<a class="dropdown-item" href="?page=user/manage_user&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-success"></span> Edit</a>
