		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<!-- <div class="form-group">
					...
					<textarea name="about" id="" cols="30" rows="2" class="form-control summernote"><?php echo  is_file(base_app . 'about.html') ? file_get_contents(base_app . 'about.html') : "" ?></textarea>
				</div> -->
				<div class="form-group">
