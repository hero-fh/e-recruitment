...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">List of Exam Categories</h3>
...
<script>
	$(document).ready(function() {
		...
		$('.delete_data').click(function() {
			_conf("Are you sure to delete this category permanently? It will also delete all the Exams alongisde with it.", "delete_category", [$(this).attr('data-id')])
		})
