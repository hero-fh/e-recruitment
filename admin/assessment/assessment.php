                    ...
                    <fieldset class="border-bottom border-info">
                        ...
                        <div class="row ">
                            <div class="form-group address-holder col-sm-4">
                                ...
                                <input type="number" class="form-control form-control-sm rounded-0" required id="rating" name="rating" placeholder="RATINGS" value="<?php echo isset($score) ? $score : $score ?>">
                            </div>
                            <div class="form-group address-holder col-sm-4">
                        ...
                        <div class="row">
                            <div class="form-group address-holder1 col-sm-12">
                                ...
                                <textarea rows="2" class="form-control" name="comment" required placeholder="COMMENTS" value="<?php echo isset($comment) ? $comment : '' ?>"></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group address-holder1 col-sm-4">
                        ...
                        <div class="row">
                            <div class="form-group address-holder2 col-sm-12">
                                ...
                                <textarea rows="2" class="form-control" name="comment1" placeholder="COMMENTS" value="<?php echo isset($comment1) ? $comment1 : '' ?>" placeholder=""></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-4">
                                ...
                                <input type="date" class="form-control  form-control-sm rounded-0" placeholder="DATE COMMENCEMENT" id="commencement" name="commencement" value="<?php echo isset($commencement) ? $commencement : '' ?>">
                            </div>
                            <div class="form-group form-inline col-sm-4">
                            </div>
                        </div><br><br>
...
<script src="<?php echo base_url ?>dist/js/assessment.js"></script>