                    ...
                    <fieldset class="border-bottom border-info">
                        ...
                        <div class="row">
                            <div class="form-group address-holder1 col-sm-12">
                                ...
                                <textarea rows="2" class="form-control textarea" name="comment" placeholder="COMMENTS" value="<?php echo isset($comment) ? $comment : '' ?>"></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group address-holder1 col-sm-4">
...
<script src="<?php echo base_url ?>dist/js/dept_assessment.js"></script>