                        ...
                        <?php else : ?>
                            ...
                            <div class="card-body address-holder<?= $exam_id['id'] ?> hidden">
                                ...
                                <div class="" id="question-list">
                                    ...
                                    if (isset($id)) :
                                        $qi = 1;
                                        $question = $conn->query("SELECT q.*,e.status FROM `question_list` q inner join exam_list e on q.exam_id = e.id WHERE e.status = 1 and e.id = '{$exam_id['id']}' order by RAND() ");
                                        while ($row = $question->fetch_assoc()) :
                                    ?>
                                            <div class=" question-item py-4 <?= $qi != 1 ? "" : '' ?>">
                                                <div class="d-flex align-items-top mb-3">
