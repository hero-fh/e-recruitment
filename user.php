<?php
$qry = $conn->query("SELECT * FROM applicants where id = '{$_settings->userdata('id')}' ");
if ($qry->num_rows > 0) {
...
<div class="card card-outline card-primary">
    ...
    <div class="card-footer text-center">
        <button class="btn btn-flat btn-sm btn-primary" type="submit" form="client-form">Update</button>
